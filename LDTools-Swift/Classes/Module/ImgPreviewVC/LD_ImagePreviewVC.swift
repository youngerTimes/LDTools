...
/// 图片查看器
public class LD_ImagePreviewVC: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        collectionView.register(LD_ImagePreviewCell.self, forCellWithReuseIdentifier: "cell")
...
extension LD_ImagePreviewVC:UICollectionViewDelegate, UICollectionViewDataSource,
UICollectionViewDelegateFlowLayout{
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        -> UICollectionViewCell {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell",
                                                          for: indexPath) as! LD_ImagePreviewCell
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        if let cell = cell as? LD_ImagePreviewCell{
