...
public class LD_ImagePreviewCell: UICollectionViewCell {
    //滚动视图
    ...
    @objc func tapSingleDid(_ ges:UITapGestureRecognizer){
        //显示或隐藏导航栏
        if let nav = self.ld_firstVC()?.navigationController{
...
extension LD_ImagePreviewCell:UIScrollViewDelegate{
