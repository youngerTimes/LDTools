...
open class LD_CustomVTMagicVC: LD_BaseVC {
    ...
    public func setSlider(radius:CGFloat = 0,grandientColor:[CGColor]? = nil)->(UIView,CAGradientLayer?){
        ...
        layerView.ld_masksToBounds = true
        layerView.ld_cornerRadius = radius
        // fillCode
...
extension LD_CustomVTMagicVC: VTMagicViewDataSource {
