//
//  LD_XCGLoggerTool.swift
//  LDTools-Swift
//
//  Created by 无故事王国 on 2021/2/18.
//
...
public func LD_SetUpLogger(_ path:String = "log.txt",showIdentifier:Bool = false,showFunctionName:Bool = true,showThreadName:Bool = true,showLevel:Bool = true,showFileName:Bool = true,showLineNumber:Bool = true,showDate:Bool = true)->XCGLogger{
