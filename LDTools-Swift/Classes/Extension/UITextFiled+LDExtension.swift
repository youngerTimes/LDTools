...
public extension UITextField{
    ...
    /// 设置占位文字的颜色
    var ld_placeholderColor:UIColor {
        get{
    ...
    func ld_validateInput(_ limitInput:String,limitLen:Int? = 0)->Bool{
