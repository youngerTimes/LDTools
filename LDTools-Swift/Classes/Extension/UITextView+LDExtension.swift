...
public extension UITextView{
    ...
    ///   - string: 文本
    ///   - withURLString: 链接文本
    func ld_appendLinkString(string:String, withURLString:String = "") {
          //原来的文本内容
    ...
    /// 转换特殊符号标签字段,并输出富文本
    func ld_resolveHashTags(_ chars:String = "@#"){
        ...
        for sentence in sentences {
            ...
            if !verifyUrl(sentence as String) {
                ...
                for i in 0..<words.count{
                    let word = words[i]
                    let keyword = ld_chopOffNonAlphaNumericCharacters(word as String)
                    if keyword != "" && i>0{
     ...
     */
    func ld_chopOffNonAlphaNumericCharacters(_ text:String) -> String {
